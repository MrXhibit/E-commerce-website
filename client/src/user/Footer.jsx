...
import { Box, Typography, Container, TextField, Button, Link, IconButton, Grid } from '@mui/material';
...
const Footer = () => {
  return (
    <Box component="footer" sx={{ backgroundColor: (theme) => theme.palette.primary.main, color: (theme) => theme.palette.primary.contrastText, pt: 6, pb: 3, mt: 8 }}>
        ...
        <Grid spacing={4} justifyContent="center">
          ...
          <Grid xs={12} md={3}>
            ...
            <Typography variant="body2" color="inherit">
              123 Shopping Street<br />India<br />
