...
import { Box, Container, Typography, Grid, Card, CardMedia, CardContent, CardActions, Button, IconButton, Chip, Stack, CircularProgress, Alert, TextField, Snackbar, InputAdornment, Breadcrumbs, Link } from '@mui/material';
...
const mockProducts = [
  // Electronics
  { _id: 'elec1', name: 'iPhone 15 Pro Max', price: 1199, category: 'Electronics', subcategory: 'smartphones', images: [{ url: 'https://images.unsplash.com/photo-1592750475338-74b7b21085ab?w=400' }], description: 'Latest iPhone with advanced camera system' },
  { _id: 'elec2', name: 'MacBook Pro 16"', price: 2499, category: 'Electronics', subcategory: 'laptops', images: [{ url: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=400' }], description: 'Powerful laptop for professionals' },
  { _id: 'elec3', name: 'Dell XPS 13', price: 1299, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1547082299-de196ea013d6?w=400' }], description: 'High-performance desktop computer' },
  { _id: 'elec4', name: 'Sony WH-1000XM5', price: 399, category: 'Electronics', subcategory: 'headphones', images: [{ url: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400' }], description: 'Noise-canceling wireless headphones' },
  { _id: 'elec5', name: 'PlayStation 5', price: 499, category: 'Electronics', subcategory: 'gaming', images: [{ url: 'https://images.unsplash.com/photo-1606813907291-d86efa9b94db?w=400' }], description: 'Next-gen gaming console' },
  { _id: 'elec6', name: 'Canon EOS R5', price: 3899, category: 'Electronics', subcategory: 'cameras', images: [{ url: 'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=400' }], description: 'Professional mirrorless camera' },
  
  // Fashion
  { _id: 'fashion1', name: 'Nike Air Jordan 1', price: 170, category: 'Fashion', subcategory: 'shoes', images: [{ url: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400' }], description: 'Classic basketball sneakers' },
  { _id: 'fashion2', name: 'Levi\'s 501 Jeans', price: 89, category: 'Fashion', subcategory: 'clothing', images: [{ url: 'https://images.unsplash.com/photo-1542272604-787c3835535d?w=400' }], description: 'Classic straight-leg jeans' },
  { _id: 'fashion3', name: 'Rolex Submariner', price: 8100, category: 'Fashion', subcategory: 'watches', images: [{ url: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=400' }], description: 'Luxury diving watch' },
  { _id: 'fashion4', name: 'Coach Handbag', price: 350, category: 'Fashion', subcategory: 'bags', images: [{ url: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400' }], description: 'Luxury leather handbag' },
  
  // Home
  { _id: 'home1', name: 'IKEA MALM Bed', price: 179, category: 'Home', subcategory: 'furniture', images: [{ url: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=400' }], description: 'Modern bed frame' },
  { _id: 'home2', name: 'KitchenAid Mixer', price: 379, category: 'Home', subcategory: 'kitchen', images: [{ url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400' }], description: 'Professional stand mixer' },
  
  // Sports
  { _id: 'sports1', name: 'Peloton Bike', price: 1445, category: 'Sports', subcategory: 'fitness', images: [{ url: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400' }], description: 'Interactive fitness bike' },
  { _id: 'sports2', name: 'Trek Mountain Bike', price: 1299, category: 'Sports', subcategory: 'cycling', images: [{ url: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400' }], description: 'All-terrain mountain bike' },
];
