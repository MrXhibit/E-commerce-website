    ...
    <>
      ...
      <Box sx={{ background: '#fafbfc', minHeight: '100vh' }}>
        ...
        <Box sx={{ backgroundColor: 'primary.main', py: 6, color: 'white' }}>
          <Container>
            <Typography variant="h3" fontWeight={700}>Sports & Fitness</Typography>
            <Typography variant="h6" sx={{ mb: 3 }}>Discover equipment and gear for your active lifestyle</Typography>
            <TextField
              placeholder="Search..."
