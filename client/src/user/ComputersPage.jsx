      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          const filteredProducts = productsData.filter(product => {
            const matchesCategory = product.subcategory?.toLowerCase() === 'computers' ||
          ...
          const mockProducts = [
            { _id: 'comp1', name: 'Dell XPS Desktop', price: 1299, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1547082299-de196ea013d6?w=400' }], description: 'High-performance desktop computer with Intel Core i7, 16GB RAM, 1TB SSD', rating: 4.7, stock: 15 },
            { _id: 'comp2', name: 'HP Pavilion Desktop', price: 899, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1593640408182-31c70c8268f5?w=400' }], description: 'Reliable desktop for everyday use with AMD Ryzen 5, 8GB RAM, 512GB SSD', rating: 4.3, stock: 22 },
            { _id: 'comp3', name: 'Gaming PC Build', price: 1899, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?w=400' }], description: 'Custom gaming desktop computer with RTX 4070, Intel i9, 32GB RAM', rating: 4.9, stock: 7 },
            { _id: 'comp4', name: 'Apple Mac Mini M2', price: 699, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?w=400' }], description: 'Compact desktop with Apple M2 chip, 8GB RAM, 256GB SSD', rating: 4.6, stock: 18 },
            { _id: 'comp5', name: 'Lenovo ThinkCentre', price: 749, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1591405351990-4726e331f141?w=400' }], description: 'Business desktop with Intel Core i5, 16GB RAM, 512GB SSD', rating: 4.2, stock: 25 },
            { _id: 'comp6', name: 'ASUS ROG Gaming Desktop', price: 2199, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1593640495253-23196b27a87f?w=400' }], description: 'Premium gaming PC with RTX 4080, AMD Ryzen 9, 64GB RAM', rating: 4.8, stock: 5 },
            { _id: 'comp7', name: 'Microsoft Surface Studio', price: 3499, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=400' }], description: 'All-in-one desktop with touchscreen display, Intel i7, 32GB RAM', rating: 4.5, stock: 3 },
            { _id: 'comp8', name: 'CyberPowerPC Gamer Supreme', price: 1599, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1625842268584-8f3296236761?w=400' }], description: 'Mid-range gaming PC with RTX 3070, AMD Ryzen 7, 16GB RAM', rating: 4.4, stock: 12 },
            { _id: 'comp9', name: 'Intel NUC Mini PC', price: 649, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1591489378430-ef2f4c626b35?w=400' }], description: 'Ultra-compact desktop for office and home use, Intel i5, 8GB RAM', rating: 4.1, stock: 20 },
            { _id: 'comp10', name: 'Alienware Aurora R15', price: 2499, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1593640408182-31c70c8268f5?w=400' }], description: 'High-end gaming desktop with liquid cooling, RTX 4090, 64GB RAM', rating: 4.9, stock: 2 },
            { _id: 'comp11', name: 'Apple iMac 24-inch', price: 1499, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1517059224940-d4af9eec41b7?w=400' }], description: 'Sleek all-in-one desktop with M1 chip, 8GB RAM, 512GB SSD', rating: 4.7, stock: 9 },
            { _id: 'comp12', name: 'MSI Aegis RS Gaming Desktop', price: 1799, category: 'Electronics', subcategory: 'computers', images: [{ url: 'https://images.unsplash.com/photo-1625842268584-8f3296236761?w=400' }], description: 'Gaming desktop with RGB lighting, RTX 3080, Intel i7, 32GB RAM', rating: 4.5, stock: 8 }
          ];
            ...
            <Box sx={carouselStyles}>
              <Carousel {...carouselSettings}>
                {featuredProducts.map((product) => (
                  <Box key={product._id} onClick={() => navigate(`/product/${product._id}`)} sx={{ cursor: 'pointer' }}>
                    <Box 
                      sx={{
                        position: 'relative',
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={3}>
              <Paper elevation={2} sx={{ p: 2, mb: 2 }}>
                ...
                {/* Types */}
                <Box sx={{ mb: 3 }}>
                  <Typography variant="subtitle1" gutterBottom>Computer Type</Typography>
                  <FormGroup>
                    {types.map((type) => (
                      <FormControlLabel
                        key={type}
                      ...
                      >
                        ...
                        <CardContent sx={{ flexGrow: 1, p: { xs: 1.5, sm: 2 } }}>
                          ...
                          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            ...
                            <Chip 
                              label={product.stock > 10 ? 'In Stock' : product.stock > 0 ? `Only ${product.stock} left` : 'Out of Stock'} 
                              size="small" 
