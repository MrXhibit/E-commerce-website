            ...
            <Box>
              <List>
                ...
                <ListItem>
                  ...
                  <ListItemText primary="Mon-Fri: 9:00 AM - 6:00 PM" secondary="Sat: 10:00 AM - 4:00 PM, Sun: Closed" />
                </ListItem>
              </List>
              <Divider sx={{ my: 2 }} />
              <Typography variant="subtitle1" fontWeight={600} sx={{ mb: 1 }}>Our Location</Typography>
              <Box sx={{ width: '100%', height: 120, background: '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'text.secondary', borderRadius: 1 }}>
