      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          const filteredProducts = productsData.filter(product => {
            const matchesCategory = product.subcategory?.toLowerCase() === 'headphones' ||
          ...
          const mockProducts = [
            { _id: 'head1', name: 'Sony WH-1000XM5', price: 399, category: 'Electronics', subcategory: 'headphones', images: [{ url: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400' }], description: 'Noise-canceling wireless headphones' },
            { _id: 'head2', name: 'Apple AirPods Pro', price: 249, category: 'Electronics', subcategory: 'headphones', images: [{ url: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400' }], description: 'Premium wireless earbuds' },
            { _id: 'head3', name: 'Bose QuietComfort', price: 329, category: 'Electronics', subcategory: 'headphones', images: [{ url: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400' }], description: 'Comfortable noise-canceling headphones' },
          ];
