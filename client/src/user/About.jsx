      ...
      <Grid container spacing={4} justifyContent="center" direction="row" sx={{ mb: 6 }}>
        ...
        <Grid item xs={12} sm={4} md={4} display="flex" justifyContent="center">
          <Box sx={{ textAlign: 'center', width: 220 }}>
            ...
            <Typography variant="body2" color="text.secondary">Continuously improving our platform and services to meet evolving customer needs.</Typography>
          </Box>
        </Grid>
      </Grid>
      {/* Numbers */}
        ...
        {team.map((member, idx) => (
          <Grid item xs={12} sm={4} key={idx} display="flex" justifyContent="center">
            <Box sx={{ textAlign: 'center', width: 220 }}>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mt: 1 }}>{member.desc}</Typography>
            </Box>
          </Grid>
        ))}
      </Grid>
