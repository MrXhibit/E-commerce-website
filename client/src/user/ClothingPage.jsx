      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          const filteredProducts = productsData.filter(product => {
            const matchesCategory = product.subcategory?.toLowerCase() === 'clothing' ||
          ...
          const mockProducts = [
            { _id: 'cloth1', name: 'Cotton T-Shirt', price: 29, category: 'Fashion', subcategory: 'clothing', images: [{ url: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400' }], description: 'Comfortable cotton t-shirt' },
            { _id: 'cloth2', name: 'Denim Jeans', price: 89, category: 'Fashion', subcategory: 'clothing', images: [{ url: 'https://images.unsplash.com/photo-1542272604-787c3835535d?w=400' }], description: 'Classic straight-leg jeans' },
            { _id: 'cloth3', name: 'Summer Dress', price: 79, category: 'Fashion', subcategory: 'clothing', images: [{ url: 'https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=400' }], description: 'Light and airy summer dress' },
          ];
            ...
            {filteredProducts.length > 0 ? (
              ...
              <Box sx={{ textAlign: 'center', py: 8 }}>
                ...
                <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
                  {searchTerm 
                    ? `No clothing matches "${searchTerm}"`
                    : 'No clothing available at the moment'
                  }
                </Typography>
                {searchTerm && (
                  <Button 
